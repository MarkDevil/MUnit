...
import cn.autotest.framework.annotation.RunOption;
...
public class MUnit extends Suite {
	...
	public MUnit(Class<?> kickoffClass, RunnerBuilder builder) throws InitializationError {
		...
		try {
			...
			filter(tagFilter);
			logger.info("Complete to file test case");
