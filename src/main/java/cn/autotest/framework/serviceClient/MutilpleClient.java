 ...
 * Desc :
 */
public class MutilpleClient implements ClientEngine {
    @Override
    ...
    private static Logger log = LoggerFactory.getLogger(MutilpleClient.class);
    /**
    ...
    public static void main(String[] args) {
        ...
        map.put("url","http://localhost:5000/getstocks");
        map.put("params","mark&1");
        map.put("encode","utf-8");
        paramlist.add(map);

        String[] returnarray = threadGet(paramlist);
        log.info("返回数据 ： {}", Arrays.toString(returnarray));
    }
